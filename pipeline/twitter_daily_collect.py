...
MODEL_VERSION_SUFFIX = r"(?:[-.]?\d+(?:\.\d+)*)?"
AI_STRONG_SIGNAL_PATTERN = (
    r"(?<![A-Za-z0-9])(?:"
    rf"xAI|GPT{MODEL_VERSION_SUFFIX}|"
    rf"ChatGPT{MODEL_VERSION_SUFFIX}|Claude{MODEL_VERSION_SUFFIX}|"
    r"Opus|Sonnet|Haiku|OpenAI|Anthropic|"
    rf"Gemini{MODEL_VERSION_SUFFIX}|Grok{MODEL_VERSION_SUFFIX}|"
    r"Agents?|Agentic|Codex|DeepSeek|Fable|Artifacts|opencode|Cursor|"
    rf"Hermes|Obsidian|NotebookLM|prompts?|Llama{MODEL_VERSION_SUFFIX}|"
    rf"Mistral{MODEL_VERSION_SUFFIX}|RAG|TTS|"
    rf"Qwen{MODEL_VERSION_SUFFIX}(?:-[A-Za-z0-9]+(?:\.[0-9]+)*)*"
    r")(?![A-Za-z0-9])|"
    r"(?:"
